    ...
    <div class="carousel rounded relative overflow-hidden   px-24 py-24">
        <div class="carousel-inner relative overflow-hidden w-full hidden md:w-5/8 md:block">
          ...
          <input class="carousel-open" type="radio" id="carousel-1" name="carousel" aria-hidden="true" hidden=""
            checked="checked">
          <div class="carousel-item absolute opacity-0 bg-center bg-cover" style="height:570px;  background-image: url(https://static.zara.net/photos///2021/I/T/2/p/0575/531/712/2/w/1224/0575531712_15_1_1.jpg?ts=1632412684667)">
          ...
          <div class="carousel-item absolute opacity-0 bg-center bg-cover" style="height:570px; background-image: url(https://static.zara.net/photos///2021/I/0/1/p/9065/488/306/32/w/1224/9065488306_15_2_1.jpg?ts=1632391411843)">
          </div>
          ...
          <div class="carousel-item absolute opacity-0 bg-cover bg-center" style="height:570px; background-image: url(https://static.zara.net/photos///2021/I/0/1/p/9632/305/600/32/w/1224/9632305600_15_2_1.jpg?ts=1632327976176)">
          </div>
          <label for="carousel-2"
