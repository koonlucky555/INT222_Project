...
export default {
  ...
  data() {
    return {
      ...
      urlUniqlo:
        "https://walkincloset.ddns.net/backend/Products/GetProducts/Brands/unq",
      urlHm:"https://walkincloset.ddns.net/backend/Products/GetProducts/Brands/hm",
      urlZara:"https://walkincloset.ddns.net/backend/Products/GetProducts/Brands/zr",
      allProductData: [],
    };
  },
  props: ["product"],
  ...
  methods: {
    ...
    fetchBrands() {
      const requestUniqlo = axios.get(this.urlUniqlo);
      ...
      axios
        ...
        .then((data) => {
          this.getUniqloArray = data[0].data;
          this.getHmArray = data[1].data;
          this.getZaraArray = data[2].data;
          console.log(this.getUniqloArray);
          console.log(this.getHmArray);
          console.log(this.getZaraArray);
        })
        .catch((errors) => {
          console.log(errors);
        });
