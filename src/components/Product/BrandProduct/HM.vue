  ...
  >
    ...
    <section class="bg-white py-8">
      <div class="container mx-auto flex items-center flex-wrap pt-4 pb-12">
        ...
        <div
          class="w-full md:w-2/4 xl:w-1/4 p-16 flex flex-col"
          v-for="hm in filteredHmProduct"
          :key="hm.id"
          :hm="hm"
        >
          <img
            class="hover:grow hover:shadow-lg w-72 h-72 object-cover"
            :src="`https://walkincloset.ddns.net/backend/Images/Get/${hm.productId}.jpg`"
            @click="emitShow(hm.productId)"
          />
          <div class="space-y-2">
            ...
            <p class="text-md Barlow font-bold">
              {{ hm.brandId.brandName }}
            </p>
            <div class="space-x-2">
              <color-block
                width="w-6"
                height="h-6"
                v-for="hmcolor in hm.productColors"
                :key="hmcolor.colorId"
                :codeColor="hmcolor.codeColor"
